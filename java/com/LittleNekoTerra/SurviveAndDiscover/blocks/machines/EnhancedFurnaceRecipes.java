...
public class EnhancedFurnaceRecipes 
{	
	private static final EnhancedFurnaceRecipes INSTANCE = new EnhancedFurnaceRecipes();
	private final Table<ItemStack, ItemStack, ItemStack> smeltingList = HashBasedTable.<ItemStack, ItemStack, ItemStack>create();
	private final Map<ItemStack, Float> experienceList = Maps.<ItemStack, Float>newHashMap();
	
	public static EnhancedFurnaceRecipes getInstance()
	{
		return INSTANCE;
	}
	
	private EnhancedFurnaceRecipes() 
	{
		//fungal core is a placeholder
		addSinteringRecipe(new ItemStack(ModItems.STEEL), new ItemStack(ModItems.FUNGAL_CORE), new ItemStack(ModItems.MUSHROOM_STEEL), 0.0F);
	}
