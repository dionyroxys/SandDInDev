...
public class ContainerEnhancedFurnace extends Container
{
	...
	public ContainerEnhancedFurnace(InventoryPlayer player, TileEntityEnhancedFurnace tileentity)
	{
		...
		this.addSlotToContainer(new SlotEnhancedFurnaceOutput(player.player, tileentity, 3, 81, 36));
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) 
	{
		...
		if(slot != null && slot.getHasStack()) 
		{
			...
			{		
				...
				if(!EnhancedFurnaceRecipes.getInstance().getAlloyResult(stack1, slot1.getStack()).isEmpty())
				{
					if(!this.mergeItemStack(stack1, 0, 2, false)) 
					{
						return ItemStack.EMPTY;
					}
					else if(TileEntityEnhancedFurnace.isItemFuel(stack1))
					{
